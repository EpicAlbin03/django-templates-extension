...
- VS Code extension: [django-templates-vscode](./packages/django-vscode) / [TODO](https://marketplace.visualstudio.com/items?itemName=EpicAlbin03.django-templates-vscode)
