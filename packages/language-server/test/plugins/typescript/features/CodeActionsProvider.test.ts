...
describe("CodeActionsProvider", function () {
	recursiveServiceWarmup(this, path.join(testDir, "testfiles", "code-actions"), pathToUrl(testDir))
							...
							edits: [
								{
									...
									range: Range.create(Position.create(0, 8), Position.create(0, 8))
								}
							],
							textDocument
						}
					...
					documentChanges: [
						{
							edits: [
								{
									newText: "// @ts-ignore\n    ",
									range: Range.create(Position.create(2, 4), Position.create(2, 4))
								}
							],
							textDocument
						}
					...
					documentChanges: [
						{
							edits: [
								{
									newText: "// @ts-ignore\n    ",
									range: Range.create(Position.create(3, 4), Position.create(3, 4))
								}
							],
							textDocument
						}
					...
					documentChanges: [
						{
							edits: [
								{
									newText: "\n// @ts-nocheck",
									range: Range.create(Position.create(0, 25), Position.create(0, 25))
								}
							],
							textDocument
						}
	...
	it("provides source action for adding all missing imports", async () => {
		...
		assert.ok(addImportsAction.data, "Add missing imports action should have data for resolution")
