...
describe("HTML Plugin", () => {
	...
	it("provides rename for element", () => {
		...
		assert.deepStrictEqual(plugin.prepareRename(document, Position.create(0, 28)), pepareRenameInfo)
		...
		assert.deepStrictEqual(plugin.rename(document, Position.create(0, 28), newName), renameInfo)
	})
