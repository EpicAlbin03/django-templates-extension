...
import type { DocumentMapper, TagInformation } from "../../lib/documents/index.js";
...
export class CSSDocument extends ReadableDocument implements DocumentMapper {
  ...
  constructor(
    ...
    this.stylesheet = getLanguageService(languageServices, this.languageId).parseStylesheet(this);
  }
