...
export class LSAndTSDocResolver {
	constructor(
		...
		this.lsDocumentContext = {
			...
			projectService,
			watchDirectory: this.options?.watchDirectory ? this.watchDirectory.bind(this) : undefined,
	...
	private async updateExistingFile(path: string, cb: (service: LanguageServiceContainer) => void) {
